...
public class GoogleUtils {
    ...
    // public String getToken(final String code) throws ClientProtocolException,
    // IOException {
    ...
    // .add("redirect_uri", env.getProperty("google.redirect.uri")).add("code",
    // code)
    ...
    // public GooglePojo getUserInfo(final String accessToken) throws
